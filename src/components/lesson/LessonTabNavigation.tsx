...
interface LessonTabNavigationProps {
  activeSection: 'lesson' | 'discussions' | 'activity';
  setActiveSection: (section: 'lesson' | 'discussions' | 'activity') => void;
  commentsCount: number;
}

export const LessonTabNavigation: React.FC<LessonTabNavigationProps> = ({
  activeSection,
  setActiveSection,
  commentsCount
}) => {
