...
interface ExamTitleSectionProps {
  exam: Exam;
  formatTimeAgo: (dateString: string) => string;
}

export const ExamTitleSection: React.FC<ExamTitleSectionProps> = ({
  exam,
  formatTimeAgo
}) => {
  return (
    <div className="liquid-glass bg-gradient-to-r from-green-900 to-green-800 text-white px-6 py-6 rounded-xl mb-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm">
            <div className="flex items-center">
              ...
              <span className="text-white font-medium ml-1">{exam.author.username}</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-indigo-100 ml-1">{formatTimeAgo(exam.created_at)}</span>
            </div>
