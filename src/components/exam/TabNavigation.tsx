...
import { Award, MessageSquare, GitPullRequest, Activity } from 'lucide-react';
...
interface TabNavigationProps {
 activeSection: 'exam' | 'discussions' | 'proposals' | 'activity';
 setActiveSection: (section: 'exam' | 'discussions' | 'proposals' | 'activity') => void;
